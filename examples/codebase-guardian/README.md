...
Always-on GitHub PR security reviewer. Scans every pull request for hardcoded secrets, injection patterns, and XSS. Pages security lead for critical findings. 15 ForgeOS runtime controls per iteration.

...
AGENT_DEFINITIONS: list[dict] = [
    ...
    {"id": "comp-analyzer", "name": "Comparable Sales Analyzer", "dept": "search", "tier": AgentTier.WORKER, "model": "claude-haiku-4-5-20251001", "max_turns": 25},
    {"id": "neighborhood-research", "name": "Neighborhood Research Agent", "dept": "search", "tier": AgentTier.WORKER, "model": "claude-haiku-4-5-20251001", "max_turns": 20},
    {"id": "property-scorer", "name": "Property Scoring Agent", "dept": "search", "tier": AgentTier.WORKER, "model": "claude-haiku-4-5-20251001", "max_turns": 20},

    # Transaction (6)
    {"id": "tx-lead", "name": "Transaction Operations Lead", "dept": "transaction", "tier": AgentTier.DEPARTMENT_LEAD, "model": "claude-haiku-4-5-20251001", "max_turns": 40},
    ...
    {"id": "offer-drafter", "name": "Offer Drafting Agent", "dept": "transaction", "tier": AgentTier.WORKER, "model": "claude-haiku-4-5-20251001", "max_turns": 30},
    {"id": "counter-negotiator", "name": "Counter-Offer Negotiation Agent", "dept": "transaction", "tier": AgentTier.WORKER, "model": "claude-haiku-4-5-20251001", "max_turns": 30},
    {"id": "inspection-coordinator", "name": "Inspection Coordination Agent", "dept": "transaction", "tier": AgentTier.WORKER, "model": "claude-haiku-4-5-20251001", "max_turns": 20},
    {"id": "closing-coordinator", "name": "Closing Coordination Agent", "dept": "transaction", "tier": AgentTier.WORKER, "model": "claude-haiku-4-5-20251001", "max_turns": 25},

    # Finance (4)
    {"id": "fin-lead", "name": "Finance Lead", "dept": "finance", "tier": AgentTier.DEPARTMENT_LEAD, "model": "claude-haiku-4-5-20251001", "max_turns": 30},
    {"id": "mortgage-connector", "name": "Mortgage Connection Agent", "dept": "finance", "tier": AgentTier.WORKER, "model": "claude-haiku-4-5-20251001", "max_turns": 20},
    ...
    {"id": "support-agent", "name": "Client Support Agent", "dept": "support", "tier": AgentTier.WORKER, "model": "claude-haiku-4-5-20251001", "max_turns": 20},
    ...
    # Legal (2)
    {"id": "legal-lead", "name": "Legal Lead", "dept": "legal", "tier": AgentTier.DEPARTMENT_LEAD, "model": "claude-haiku-4-5-20251001", "max_turns": 25},
    {"id": "compliance-agent", "name": "Compliance Agent", "dept": "legal", "tier": AgentTier.WORKER, "model": "claude-haiku-4-5-20251001", "max_turns": 20},
]

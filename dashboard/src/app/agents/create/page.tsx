          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea value={form.system_prompt} onChange={(e) => update('system_prompt', e.target.value)} className="w-full rounded-lg border-gray-300 font-mono text-xs" rows={10} placeholder="Instructions for the agent — what it should do every time it runs." />
              </div>
            </div>

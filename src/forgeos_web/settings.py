...
ROOT_URLCONF = "src.forgeos_web.urls"
ASGI_APPLICATION = "src.forgeos_web.asgi.application"
...
INSTALLED_APPS = [
    ...
    "django_celery_beat",
    # ForgeOS web apps
    "src.forgeos_web.health",
    "src.forgeos_web.auth_app",
    "src.forgeos_web.rbac",
    "src.forgeos_web.tenancy",
    "src.forgeos_web.eventbus",
    "src.forgeos_web.clients",
    "src.forgeos_web.agents",
    "src.forgeos_web.hitl",
    "src.forgeos_web.ontology",
    "src.forgeos_web.secrets",
    "src.forgeos_web.environments",
    "src.forgeos_web.runtime",
    "src.forgeos_web.governance",
    # View-only apps (endpoint ports)
    "src.forgeos_web.approvals",
    "src.forgeos_web.mcps",
    "src.forgeos_web.kernel",
    "src.forgeos_web.namespaces",
    "src.forgeos_web.credentials",
    "src.forgeos_web.admin_app",
    "src.forgeos_web.intelligence",
    "src.forgeos_web.billing",
    "src.forgeos_web.audit_events",
    "src.forgeos_web.sandbox",
    "src.forgeos_web.pages",
    "src.forgeos_web.chat",
    "src.forgeos_web.rls_policies",
]

MIDDLEWARE = [
    "corsheaders.middleware.CorsMiddleware",
    "src.forgeos_web.common.middleware.SecurityHeadersMiddleware",
    ...
    # ATOMIC_REQUESTS).
    "src.forgeos_web.db.middleware.RLSMiddleware",
]
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "src.forgeos_web.authn.authentication.ForgeOSAuthentication",
    ],
    "DEFAULT_PERMISSION_CLASSES": [
        "src.forgeos_web.authn.permissions.IsAuthenticatedOrPublicPath",
    ],
    "EXCEPTION_HANDLER": "src.forgeos_web.common.exceptions.forgeos_exception_handler",
